...
<p>
  ...
  <a href="https://doi.org/10.5281/zenodo.21297455"><img src="https://img.shields.io/badge/DOI-10.5281%2Fzenodo.21297455-1682D4" alt="DOI"></a>
...
- **真代码、真运行** —— `model.py` 是一个 1-D FNO;完整实验在笔记本 CPU 上约 35 分钟跑完。
- **实测结果** —— FNO 4.41% rel-L2,优于 MLP 21.63%、CNN 67.69%(3 seeds);零样本超分辨率在 128→1024 网格上稳定于 4.2–4.7%。
